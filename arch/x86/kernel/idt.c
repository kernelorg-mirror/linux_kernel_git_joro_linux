...
#ifdef CONFIG_X86_64
/*
 * This function does the same as idt_setup_early_handler(), but is called
 * directly from head_64.S right after the kernel switched to virtual addresses.
 * PV-ops don't work at that point, so we can't use set_intr_gate() here.
 */
